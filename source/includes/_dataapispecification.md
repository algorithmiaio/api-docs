...
* Query-parameters:
    ...
    * "marker=12-4s4" returns the page of results starting at marker "12-4s4", only valid for markers previously returned by this API.  If this
    parameter is omitted then the first page of results is provided.
...
GET @apiUrl/data/:owner/:collection_name/:file_name
```
...
are deprecated. This will be supported until 2015-12-31.
